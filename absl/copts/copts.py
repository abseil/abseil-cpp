...
ABSL_INTEL_LLVM_CLANG_CL_ADDITIONAL_FLAGS = [
    # IntelLLVM uses /fp:fast by default for Release builds,
    # which breaks NaN and Inf handling.
    "/fp:precise",
]
...
COPT_VARS = {
    ...
    "ABSL_INTEL_LLVM_FLAGS": GccStyleFilterAndCombine(
        ABSL_LLVM_FLAGS, ABSL_INTEL_LLVM_ADDITIONAL_FLAGS),
    "ABSL_INTEL_LLVM_TEST_FLAGS": GccStyleFilterAndCombine(
        GccStyleFilterAndCombine(ABSL_LLVM_FLAGS, ABSL_INTEL_LLVM_ADDITIONAL_FLAGS),
        ABSL_LLVM_TEST_ADDITIONAL_FLAGS),
    "ABSL_CLANG_CL_FLAGS":
        MSVC_BIG_WARNING_FLAGS + MSVC_DEFINES,
    "ABSL_CLANG_CL_TEST_FLAGS":
        MSVC_BIG_WARNING_FLAGS + MSVC_DEFINES + ABSL_LLVM_TEST_ADDITIONAL_FLAGS,
    "ABSL_INTEL_LLVM_CLANG_CL_FLAGS":
        MSVC_BIG_WARNING_FLAGS + MSVC_DEFINES + ABSL_INTEL_LLVM_CLANG_CL_ADDITIONAL_FLAGS,
    "ABSL_INTEL_LLVM_CLANG_CL_TEST_FLAGS":
        MSVC_BIG_WARNING_FLAGS + MSVC_DEFINES + ABSL_INTEL_LLVM_CLANG_CL_ADDITIONAL_FLAGS + ABSL_LLVM_TEST_ADDITIONAL_FLAGS,
    "ABSL_MSVC_FLAGS":
