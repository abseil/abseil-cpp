    ...
    for exceptions_mode in ${EXCEPTIONS_MODE}; do
      ...
      time docker run \
        ...
        /usr/local/bin/bazel test ... \
          ...
          --action_env=BAZEL_LINKOPTS=-L/opt/llvm-tsan/lib/x86_64-unknown-linux-gnu:-lc++:-lc++abi:-lm:-Wl,-rpath=/opt/llvm-tsan/lib/x86_64-unknown-linux-gnu \
          --action_env=CPLUS_INCLUDE_PATH=/opt/llvm-tsan/include/c++/v1:/opt/llvm-tsan/include/x86_64-unknown-linux-gnu/c++/v1/ \
